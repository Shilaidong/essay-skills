...
4. **Build the analysis model.**
   ...
   - When the user only has the Big Five without LSI-II: drop the life-story / future-script sections, mark them as "数据未采集".
   - When the user only has LSI-II without Big Five: keep the chapter/moment narrative and add a small note that the personality layer is missing.
...
5. **Write for the student.**
   ...
   - If a section is incomplete, say what can and cannot be inferred. Do not over-read blanks. Empty chapters or missing moments are not "the student has no X".
