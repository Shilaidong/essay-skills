...
compatibility: Requires `sn-image-base` skill and its Python dependencies. Run the setup script first.
allowed-tools: Bash(pip *), Bash(python scripts/*.py *)
metadata:
...
This installs `sn-image-base` dependencies and configures the API key automatically.
